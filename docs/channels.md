...
This reference describes optional delivery for OMP Tandem 3.3.0. Bounded MCP polling works without Channels or hooks. Channels are a Claude Code feature, not a portable MCP guarantee and not a permission-approval relay.
