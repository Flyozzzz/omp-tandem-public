...
**3.7.1 — локальное предложение, не опубликовано.** [CHANGELOG](CHANGELOG.md). Сборка/проверка пакета не создаёт тег, не публикует, не устанавливает пакет в пользовательскую сессию и не применяет код.
