...
Пакет 3.7.1 выпущен 2026-09-13; см. [CHANGELOG](CHANGELOG.md). Сборка/проверка пакета не создаёт тег, не публикует, не устанавливает пакет в пользовательскую сессию и не применяет код.
