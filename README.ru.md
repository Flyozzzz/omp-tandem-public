...
Репозиторий начинается с проверенного снимка предыдущей приватной разработки. **3.0.1** сохраняет последовательность версий, но старая Git-история не импортирована. «Legacy history» относится к локальным беседам OMP, а не к скрытым Git-коммитам.
