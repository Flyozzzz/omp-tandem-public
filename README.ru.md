...
- **План до нетривиальной разработки.** Независимая оценка напарника, конкретный общий план, реализация и взаимная проверка; узкие исключения для механических правок и неизменившихся утверждённых планов.
