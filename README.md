...
Package 3.7.1 was released on 2026-09-13; see the [changelog](CHANGELOG.md). Building/checking packages does not tag, publish, install into a user session or apply code.
